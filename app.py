...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://bloosrootuser:ZqKmfJqUgenk3yOtW12hJ3@bloss-staging.crxhffngcxjs.ap-south-1.rds.amazonaws.com:3306/test'
db.init_app(app)
